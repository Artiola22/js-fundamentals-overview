...
let radiusSquared = Math.pow(10,2);
...
let newVolvo = garage.find( car => car === 'volvo')
...
myself.favouriteFoods = ["Fish", "Chicken"]
...
console.log(eat.eat("Artiola", "pizza!"))